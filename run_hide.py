...
destination_path = '~/anaconda2/lib/python2.7/site-packages/hide-0.1.0-py2.7.egg/hide/config/' # change to your destination (the place where your hide package is located within your python repository)

working_path = '/home/lucas/Documentos/work/hidetest/hide/hide/config/' # change to your working path
