...
# BEAM
# ==================================================================
beam_profile_provider = "hide.beam.gaussian"
beam_frequency_min = 960.       # minimum frequency: [MHz]
beam_frequency_max = 1260.      # maximum frequency: [MHz]
...
strategy_end   = "2018-01-10-23:59:59"     # survey end time. Format YYYY-mm-dd-HH:MM:SS
...
astro_signal_file_name = "maps_foregrounds_test.fits" # maps (n_channels vs n_pixels) file name, located in the data/sky directory
astro_signal_freq_file_name = "freqs_foregrounds_test.fits" # frequency (n_channels) file name, located in the data/sky directory
...
delta_nu = 10.e6                   # channel width, in Hz
color_alpha = 1.                  # 1 /f alpha parameter
